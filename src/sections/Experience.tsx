  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] px-6 py-28 md:px-14 md:py-40">
        <h2 className="exp-title font-serif text-4xl font-semibold tracking-tight text-brand-white md:text-6xl">
            ...
            {experience.map((e) => (
              <li key={e.title} className="exp-entry grid grid-cols-1 gap-3 md:grid-cols-12 md:gap-8">
                <div className="md:col-span-3">
                  <p className="font-mono text-sm text-gold">{e.years}</p>
                </div>
                <div className="md:col-span-9">
                  <h3 className="font-serif text-2xl font-medium text-brand-white md:text-3xl">
                    {e.title}
                  </h3>
